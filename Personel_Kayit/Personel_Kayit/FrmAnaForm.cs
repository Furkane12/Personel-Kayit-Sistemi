...
namespace Personel_Kayit
{
    public partial class FrmAnaForm : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-GD3NFC9\\SQLEXPRESS;Initial Catalog=PersonelVeriTabani;Integrated Security=True");
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Güncelleme İşleminiz Başarıyla Tamamlanmıştır.", "bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        //İstatistik Formuna Geçiş Sağlama
